...
class SurveyForm(Form):
    ...
    comp0 = MultiCheckboxField('comp0', choices=[("容姿", '容姿'), ("性格", "性格"),("家族","家族"), ("友人関係","友人関係"),("恋愛","恋愛"),("周囲の評価","周囲の評価"),("過去の体験","過去の体験"),("特に無い","特に無い")])
    comp1 = MultiCheckboxField('comp1', choices=[("容姿", '容姿'), ("性格", "性格"),("家族","家族"), ("友人関係","友人関係"),("恋愛","恋愛"),("周囲の評価","周囲の評価"),("過去の体験","過去の体験"),("特に無い","特に無い")])
    ...
    media = MultiCheckboxField('media', choices=[("ネタみせ番組(ex.エンタの神様)", 'ネタみせ番組(ex.エンタの神様)'), ("トークバラエティ番組(ex.しゃべくり007)", "トークバラエティ番組(ex.しゃべくり007)"),("コメディー映画","コメディー映画"), ("youtube","youtube"),("ニコニコ動画（生放送）","ニコニコ動画（生放送）"),("２ちゃんねる（まとめ含む）","２ちゃんねる（まとめ含む）"),("お笑いライブ","お笑いライブ"),("特に無い","特に無い")])
